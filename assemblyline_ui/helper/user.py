...
def load_user_settings(user):
    ...
    settings['service_spec'] = get_default_service_spec(srv_list, settings.get('service_spec', {}), user_classification)
    settings['services'] = get_default_service_list(srv_list, def_srv_list, user_classification)
